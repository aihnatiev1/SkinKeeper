...
import 'session_gate_browser_fallback.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SessionGateBrowserFallbackSection(
              step: _step,
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: const [
              SessionGateFeatureChip('Sell Items'),
              SessionGateFeatureChip('Trade'),
              SessionGateFeatureChip('Market History'),
              SessionGateFeatureChip('Profit & Loss'),
            ],
          ),
        ],
      ),
