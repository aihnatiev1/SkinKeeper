...
class _PaywallScreenState extends ConsumerState<PaywallScreen> {
  ...
  Widget _buildFeatureList() {
    return Container(
      ...
      child: Column(
        children: [
          _featureRow('Multi-source pricing', true, true),
          _featureRow('Portfolio value tracking', true, true),
          _featureRow('Total P/L summary', true, true),
          _featureRow('Transaction history sync', true, true),
          const Divider(height: 24),
          _featureRow('Per-item P/L breakdown', false, true),
          _featureRow('P/L charts over time', false, true),
          _featureRow('Push price alerts', false, true),
